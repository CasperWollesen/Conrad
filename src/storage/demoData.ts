...
export function demoData(
  ...
  const tasks: Task[] = [
    {
      ...
      date: nextFriday,
      time: '08:00',
      note: 'Klassens fredagshygge.',
      beforeFreeTime: true,
      completedAt: null,
      prep: { title: 'Bag kage', date: addDays(nextFriday, -1), beforeFreeTime: true, completedAt: null },
      createdAt: ts,
      updatedAt: ts,
    },
    {
  ...
  const routines: Routine[] = [
    ...
    },
    {
      ...
      title: 'Tag skraldespanden ud',
      weekdays: [3],
      startDate: today,
      time: null,
      note: 'Afhentes torsdag morgen.',
      beforeFreeTime: true,
      prep: null,
      paused: false,
      createdAt: ts,
